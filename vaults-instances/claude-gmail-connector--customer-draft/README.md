# Claude on one Gmail mailbox — a customer's draft — an Agent Behaviour Policy, as a vault
...
```
node scripts/site/build-abp-vault.mjs claude-gmail-connector--customer-draft
```
