...
What the paid licence adds is described by the store at <https://store.sgit.ai/ledger/#claim-entry-level-dual-licence>; its final wording is not yet drafted, and the ledger says so rather than this file implying otherwise.
...
- Template shape: `anthropic/gmail-connector/default`
