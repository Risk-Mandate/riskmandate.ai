...
- **Every change ships as a release.** [v1.19.1](versions.html) made the pages; [v1.20.1](versions.html) made the £5 page the download and set the 24 hours. The brief that asked for all of it is [D9 in the register](briefs.html), byte for byte, with what it is still owed.
