...
**Shape** A browser extension with broad host permissions (generic) · **surface** extension · **grant version** 2026-09-05 · **rows** 3, of which **0 measured** and 3 derived · **widest reach** world
...
| --- | --- | --- | --- | --- | --- | --- |
| `read.record.browsing` | Read every page you visit | ● none | no | documented | the extension | — |
| `send.endpoint.world` | Reach any host on the internet | ● none | no | documented | the extension | — |
| `authenticate-as.credential.tenant` | Act in accounts with the credentials it holds | ◐ setting | no | documented | the extension | the site's own session controls |

## The notes behind the rows

- **`read.record.browsing`** — 'read and change all your data on all websites'
