...
**Mandate id** `browser-extension-i-installed` · **status** starting-point · **authored** 2026-09-09 by the site, as a starting point — not measured, not surveyed; the first thing to argue with
...
| --- | --- | --- |
| `read.record.browsing` | Read every page you visit | host — your browser — every page, every logged-in site |

## What is explicitly not wanted (2)

| Capability | What it is | Reach |
| --- | --- | --- |
| `authenticate-as.credential.tenant` | Act in accounts with the credentials it holds | tenant — the sites you are logged into, as you |
| `send.endpoint.world` | Reach any host on the internet | world — the internet, from your browser |
