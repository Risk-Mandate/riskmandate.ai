...
| | |
| --- | --- |
| **Licensee** | A browser extension with broad host permissions — deployment shape `generic/browser-extension/broad-host-permissions`, grant version 2026-09-05 |
| **Authority** | — not yet issued to anyone — |
| **Accountable owner** | — unassigned — |
| **Instrument** | This behaviour policy: mandate `browser-extension-i-installed` (2026-09-09), delta `generic__browser-extension__broad-host-permissions__browser-extension-i-installed` (2026-09-15T01:41:06Z), vocabulary abp.sgit.ai v0.3.0 |
...
| Do not `authenticate-as.credential.tenant` (act in accounts with the credentials it holds) | the mandate refuses it | ◐ setting | the site's own session controls |
