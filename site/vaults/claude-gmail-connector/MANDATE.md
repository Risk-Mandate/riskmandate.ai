...
**Mandate id** `read-and-draft-never-send` · **status** starting-point · **authored** 2026-09-16 by the site, as a starting point — not measured, not surveyed; the first thing to argue with
