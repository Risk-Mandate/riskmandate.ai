...
| | |
| --- | --- |
| **Licensee** | An assistant connected to a personal Google Drive with the drive.readonly scope — deployment shape `google/drive/readonly-connector`, grant version 2026-09-15 |
| **Authority** | — not yet issued to anyone — |
| **Accountable owner** | — unassigned — |
| **Instrument** | This behaviour policy: mandate `reader-on-my-drive` (2026-09-15), delta `google__drive__readonly-connector__reader-on-my-drive` (2026-09-15T02:43:02Z), vocabulary abp.sgit.ai v0.3.0 |
