...
| | |
| --- | --- |
| **Licensee** | Claude Code (the CLI, on your own machine) — deployment shape `anthropic/claude-code/local-confirmations-off`, grant version 2026-09-05 |
| **Authority** | — not yet issued to anyone — |
| **Accountable owner** | — unassigned — |
| **Instrument** | This behaviour policy: mandate `coding-assistant-on-my-machine` (2026-09-09), delta `anthropic__claude-code__local-confirmations-off__coding-assistant-on-my-machine` (2026-09-15T01:41:06Z), vocabulary abp.sgit.ai v0.3.0 |
