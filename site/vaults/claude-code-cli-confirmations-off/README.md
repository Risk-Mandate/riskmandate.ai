# Claude Code on your own machine, confirmations off — an Agent Behaviour Policy, as a vault
...
```
node scripts/site/build-abp-vault.mjs claude-code-cli-confirmations-off
```
