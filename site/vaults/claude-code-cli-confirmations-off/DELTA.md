...
**Vault** `claude-code-cli-confirmations-off` · **status** template · **shape** `anthropic/claude-code/local-confirmations-off` · **grant** 2026-09-05 · **mandate** 2026-09-09 · **vocabulary** abp.sgit.ai v0.3.0 · **as at** 2026-09-15

---


**Grant** 2026-09-05 · **mandate** 2026-09-09 · **computed** 2026-09-15T01:41:06Z · **agrees row for row with** the published record `anthropic__claude-code__local-confirmations-off__coding-assistant-on-my-machine` (2026-09-11T13:00:37Z)
