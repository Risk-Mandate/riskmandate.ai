...
| `execute.process.host` | Run programs as the account | ● none | with-effort | derived | shell (Bash) | none — confirmations disabled; the tool runs whatever it decides to run |
