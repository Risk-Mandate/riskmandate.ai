...
**[The team, and what is public, private and secret: a behaviour policy for each of our own agents](../../admin/briefs/architecture__the-team-public-private-secret/)**

site/team/, served as https://riskmandate.ai/team/, in the header under Behaviour policies. One index and one page per agent, generated by scripts/site/build-team.mjs from three data files:26 September 2026 · architecture
