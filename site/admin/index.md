...
The stories vault `dy4u2m9c` was born: our side (mail/, published/, board/) went in beside the studio's folders and was pushed. The site's stories page and the docs now say so, and the board on the page is the vault's. Not in scope: the studio's replies, the schedule, stories.sgit.ai. since 26 September 2026
