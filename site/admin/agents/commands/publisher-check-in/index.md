...
> Rendered from .claude/commands/publisher-check-in.md in the repository. The text below is that file.
> Source: https://riskmandate.ai/admin/agents/commands/publisher-check-in/ · noindex · written by scripts/site/build-admin.mjs
