...
[#2 · T01 · a day**One page per behaviour: `behaviour-<id>.html`, generated from the catalogue**](../../admin/work/T01/)[#3 · T02 · a day**`data/edges.json` per vault: the grant as edges, one per path, barrier on the path**](../../admin/work/T02/)[#4 · T03 · half a day + a Lab 03 ask**Metrics on behaviours (speed, volume, blast) as coarse ordinals in a vocabulary extension**](../../admin/work/T03/)[#5 · T03 · a day**Outward links per behaviour: ATT&CK technique ids, GDPR articles, cited**](../../admin/work/T03/)[#6 · T04 · several days**Views per audience + prompts + projections, regenerated by the build, refused when stale**](../../admin/work/T04/)[#7 · T05 · a day per vault**Settle the 18 open questions across the five connector vaults**](../../admin/work/T05/)[#8 · T06 · half a day each**The next five connector vaults**](../../admin/work/T06/)[#9 · T06 · after 8**The three business-function vaults**](../../admin/work/T06/)[#10 · T07 · two hours**Lab 03: add the asks from the n8n review and the graph brief (barrier per path; a word for a broad-but-real gate; metrics and links on the primitives)**](../../admin/work/T07/)[#11 · T10 · a day, after the workflow agent runs the prompt**The two Voice Debrief use-case vaults, and a use-case group on the library**](../../admin/work/T10/)[#12 · T09 · half a day**Stop deploying the vault: inputs in the repository, the product in the vault**](../../admin/work/T09/)[#16 · T11 · two and a half days**The consequence layer for `oc433z3m`: assets, consequences, routes out, two scenarios; the research list documented from Google's pages; the standards mini-graphs**](../../admin/work/T11/)
...
waiting on the lead: four decisions in the brief §6needs the lead
